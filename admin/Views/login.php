                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                    <form class="form-signin" method="POST">                                        
                                            ...
                                            <input class="btn btn-success btn-block mt-4" type="submit" value="Acessar" />                      
                                     </form>      
                                     <?php if (isset($_SESSION['nao_logado']) && !empty($_SESSION['nao_logado'])) {
                                                echo $_SESSION['nao_logado'];
